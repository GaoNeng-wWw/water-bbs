...
export class Migration20260622014547 extends Migration {
  ...
  override up(): void | Promise<void> {
    ...
    this.addSql(`create table \`proposal_comment\` (\`id\` varchar(36) not null default '019eed01-50ef-7435-8b8f-921c39632ef7', \`created_at\` datetime not null default current_timestamp, \`updated_at\` datetime null, \`removed_at\` datetime null, \`proposal_id\` varchar(36) not null, \`account_id\` varchar(36) not null, \`comment\` text not null default (''), \`action\` enum('yes','no') not null, primary key (\`id\`)) default character set utf8mb4 engine = InnoDB;`);
    ...
    this.addSql(`create table \`proposals\` (\`id\` varchar(36) not null default '019eed01-50ee-7598-bf32-1eb23c242c2c', \`created_at\` datetime not null default current_timestamp, \`updated_at\` datetime null, \`removed_at\` datetime null, \`title\` text not null default (''), \`author_id\` varchar(36) not null, \`content\` text not null default (''), \`command\` text not null, \`start_at\` datetime not null, \`end_at\` datetime not null, \`status\` enum('active','passed','rejected','executed','cancelled') not null default 'active', \`approval_percent\` numeric(5,2) not null default 50, \`reason\` text not null default (''), \`executor_id\` text not null default (''), primary key (\`id\`)) default character set utf8mb4 engine = InnoDB;`);
    ...
    this.addSql(`create table \`vote\` (\`id\` varchar(36) not null default '019eed01-50ef-7435-8b8f-8b8e4369d41a', \`created_at\` datetime not null default current_timestamp, \`updated_at\` datetime null, \`removed_at\` datetime null, \`proposal_id\` varchar(36) not null, \`account_id\` varchar(36) not null, \`action\` enum('yes','no') not null, primary key (\`id\`)) default character set utf8mb4 engine = InnoDB;`);
    ...
    this.addSql(`create table \`vote_slot\` (\`id\` varchar(36) not null default '019eed01-50ef-7435-8b8f-8ce4f166d7b6', \`vote_id\` varchar(36) not null, \`proposal_id\` varchar(36) not null, \`slot\` int not null, \`cnt\` int not null default 1, \`action\` enum('yes','no') not null, primary key (\`id\`)) default character set utf8mb4 engine = InnoDB;`);
