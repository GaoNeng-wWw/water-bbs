...
import { UiButton, UiDialog, UiDialogContent, UiDialogTrigger } from '@/components/ui';
  ...
  <layout>
    ...
    <div class="max-w-[1200px] mx-auto w-full grow h-full flex">
      <animate-presence>
        ...
        <div class="max-w-1200px w-full mx-auto pt-7 pb-4 px-4 h-full flex">
          <router-link to="/tasks/create">
            <ui-button icon color="primary" shape="solid" rounded="lg">
              <div class="i-material-symbols:add size-4" />
            </ui-button>
          </router-link>
          <task-list />
        </div>
