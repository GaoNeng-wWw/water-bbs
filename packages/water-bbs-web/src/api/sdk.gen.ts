...
export const accountControllerGetCheckInStatus = <ThrowOnError extends boolean = false>(options?: Options<AccountControllerGetCheckInStatusData, ThrowOnError>) => (options?.client ?? client).get<AccountControllerGetCheckInStatusResponses, unknown, ThrowOnError>({
    responseType: 'json',
    url: '/account/check-in',
    ...options
});

export const accountControllerCheckIn = <ThrowOnError extends boolean = false>(options?: Options<AccountControllerCheckInData, ThrowOnError>) => (options?.client ?? client).post<AccountControllerCheckInResponses, unknown, ThrowOnError>({
    responseType: 'json',
    url: '/account/check-in',
    ...options
});
...
export const postControllerUploadResource = <ThrowOnError extends boolean = false>(options: Options<PostControllerUploadResourceData, ThrowOnError>) => (options.client ?? client).post<PostControllerUploadResourceResponses, unknown, ThrowOnError>({
    ...formDataBodySerializer,
    responseType: 'json',
...
export const postControllerListResources = <ThrowOnError extends boolean = false>(options: Options<PostControllerListResourcesData, ThrowOnError>) => (options.client ?? client).get<PostControllerListResourcesResponses, unknown, ThrowOnError>({
    responseType: 'json',
