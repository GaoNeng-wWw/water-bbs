...
describe('Category API (e2e) with Authentication', () => {
  ...
  it('should find a category by id with authentication', async () => {
  ...
  it('should update a category with authentication', async () => {
    const createResponse = await request(app.getHttpServer())
      .post('/category')
      .set('Authorization', `Bearer ${authToken}`)
      .send({
  ...
  it('should remove a category with authentication', async () => {
    const createResponse = await request(app.getHttpServer())
      .post('/category')
      .set('Authorization', `Bearer ${authToken}`)
      .send({
  ...
  it('should recover a removed category with authentication', async () => {
    const createResponse = await request(app.getHttpServer())
      .post('/category')
      .set('Authorization', `Bearer ${authToken}`)
      .send({
