...
export class AccountRepo implements IAccountRepoistory {
    ...
    findOne(account_id: AccountID): Promise<Result<Account | null, PersistenceError>> {
    ...
    findMany(account_id: AccountID, limit: number): Promise<Result<Account[], PersistenceError>> {
