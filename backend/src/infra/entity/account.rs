...
pub enum Relation {
    ...
    Cert,
    #[sea_orm(has_many = "super::dictator::Entity")]
    Dictator,
...
impl Related<super::dictator::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::Dictator.def()
    }
}
...
impl Related<super::badge::Entity> for Entity {
    fn to() -> RelationDef {
        super::user_badge::Relation::Badge.def()
    }
    fn via() -> Option<RelationDef> {
        Some(super::user_badge::Relation::Account.def().rev())
    }
}

impl Related<super::shop_item::Entity> for Entity {
    fn to() -> RelationDef {
        super::user_inventory::Relation::ShopItem.def()
    }
    fn via() -> Option<RelationDef> {
        Some(super::user_inventory::Relation::Account.def().rev())
    }
}
